            ...
            <div class="card-body">
              ...
              <div class="form-group">
				<div class="row">
					...
					<div class="col-3">
						<%--@declare id="inputprojectleader"--%><label for="inputProjectLeader">Preview</label>
...
<script>
  ...
  $('#submitBtn').click(function () {
    ...
    if (isEdit=='true'){
      url = '/AAAA_war_exploded/admin/video?action=edit&href='+ hrefOrigin;
    }else {
      url = '/AAAA_war_exploded/admin/video?action=add';
    }
    var formData = {
    ...
    $.ajax({
      ...
      window.location.href = "http://localhost:8080/AAAA_war_exploded/admin/video?action=view";
    }).fail(function (error) {
      $('#message').text('Khong ADD Duoc');
    });
  });
